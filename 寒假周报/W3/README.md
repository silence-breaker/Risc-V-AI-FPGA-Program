...
核心概念： 视障人士看不见世界，系统充当他们的“眼睛”和“嘴巴”。摄像头看到东西，通过 NPU 识别，再通过 FPGA 生成准确的语音描述（或大号文字）。

为什么“实际”？ 盲人导盲需要极低的延迟（不能撞墙）和隐私保护（不想传到云端），这完美契合我们的 FPGA 端侧加速（低延迟） 和 1.58-bit（离线运行） 的特点。
